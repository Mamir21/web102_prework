...
function addGamesToPage(games) {
    for (const game of games) {
        ...
        gameCard.innerHTML = `
            ...
            <p>Funding: $${game.pledged.toLocaleString()}</p>
        `;
...
const unfundedGamesString = numUnfundedGames === 0 ? "all" : numUnfundedGames;

// create a new DOM element containing the template string and append it to the description container
const descriptionText = `We currently have ${unfundedGamesString} unfunded game${numUnfundedGames !== 1 ? "s" : ""}. Please consider supporting these projects to help them reach their goals!`;
